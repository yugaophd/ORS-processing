...
The Northwest Tropical Atlantic Station (NTAS) is located in the tropical North Atlantic and serves as a long-term air-sea flux and upper-ocean variability reference site. With support from the NOAA Global Ocean Monitoring and Observing Program, WHOI maintains repeated NTAS mooring deployments that support climate process studies and observing-system continuity.

The moorings are deployed in an average water depth of about 5118 m and carry a broad meteorological and oceanographic sensor suite. The deep recorders analyzed here are installed near the bottom portion of the mooring line in approximately 5118 m water depth, providing a continuous deep-ocean time series across deployments. Instrument depths range from 4936 m to 5016 m.

\subsection{Deployment Strategy}

NTAS deployments are serviced on a (nominal) annual cycle, with a replacement mooring typically deployed before recovery of the previous system when possible. This strategy can produce overlap periods of hours to days across adjacent deployments, enabling direct data intercomparisons and merge-point selection.
