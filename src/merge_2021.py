# %%
# merge stratus 12 to stratus 19
# Chose 19-11394 for closer match with 18-10600 and better data quality.
# chose 20-10600 for better data quality 
# chose 21-11394 for better salinity data quality
...
project_number = 20 # the project number of the last merged dataset
version = 'v1'  # version of the dataset

case_name0 = f'{project_name}{project_number}'
instrument0_1 = '10600'  # instrument serial number for the first dataset

case_name1 = f'{project_name}{project_number+1}'
instrument1_1 = '11394'
instrument1_2 = '11379' # chosen
...
if overlap_start >= overlap_end:
    ...
    # Plotting
    extended_start = overlap_start - pd.Timedelta(hours=12)
    extended_end = overlap_end + pd.Timedelta(hours=12)
