...
# Chose NTAS19-12246 and NTAS18-11392 for merging
...
project_name = 'NTAS'
project_number = 18 # the project number of the last merged dataset

# store the results in the doc folder of the latter case
case_name0 = f'{project_name}{project_number}'
instrument0_1 = '11392' # last merged dataset
...
# %%
# resample/average NTAS 19
# NTAS 13 and 19 have different sampling frequency
# so we need to resample/average NTAS 19 to assess the difference

# Upsample NTAS 19 using linear interpolation
