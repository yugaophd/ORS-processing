...
# Chose NTAS17-11380 and NTAS16-11392 for merging
...
# %%
# resample/average NTAS 17
# NTAS 13 and 17 have different sampling frequency
# so we need to resample/average NTAS 17 to assess the difference

# Upsample NTAS 17 using linear interpolation
