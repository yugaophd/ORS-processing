...
# Chose NTAS17-11380 and NTAS18-11392 for merging
...
project_name = 'NTAS'
project_number = 17 # the project number of the last merged dataset

# store the results in the doc folder of the latter case
case_name0 = f'{project_name}{project_number}'
instrument0_1 = '11380' # last merged dataset NTAS14-11392
