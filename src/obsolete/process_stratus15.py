...
# from mooring log
water_depth_from_ship_uncorrected = 4600     # uncorrected water depth, depth recorder reading
...
# %%
# spike time
# deploy: 20160612	1825	20160612	17:29	19:00
# recover: 17:06	20170514	18:31
deployment_spike_times_start = pd.to_datetime('06/12/2016 17:29')
deployment_spike_times_end = pd.to_datetime('06/12/2016 19:00') # matching the diagram
recovery_spike_times_start = pd.to_datetime('05/14/2017 17:06')
recovery_spike_times_end = pd.to_datetime('05/14/2017 18:31') # matching the diagram
