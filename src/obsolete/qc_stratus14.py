...
# %%
# Compute and export difference statistics
...
for var in variables:
    if var in ds0:
        sensor1_data['mean'][var] = float(ds0[var].mean().values)
...
# Export difference statistics to LaTeX
...
# %% Create detailed comparison plot of original data
...
export_spike_stats(
    ...
    project_number                    # Project number (14) - corrected from '13'
)
