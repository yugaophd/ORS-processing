...
# from mooring log
water_depth_from_ship_uncorrected = 4230     # uncorrected water depth, depth recorder reading
water_depth_from_ship_corrected = 4230       # corrected water depth, best water depth
...
# %%
# spike time
# 1/25/21	11:35:00 UTC	12:04
# 1/25/21	11:35:00 UTC	12:04
deployment_spike_times_start = pd.to_datetime('01/25/2021 11:35')
deployment_spike_times_end = pd.to_datetime('01/25/2021 12:04')
recovery_spike_times_start = pd.to_datetime(np.nan) # not available in S19_recovery log
recovery_spike_times_end = pd.to_datetime(np.nan) # not available in S19_recovery log
# stop time: 20220409	16:00:10	20220409	126613
# stop time: 20220409	17:10:05	20220409	126627


# %%
# file input
# /Users/Shared/ORS/Stratus/Stratus19/Data/SBE37
mat_file_path1 = f'/Users/Shared/ORS/Stratus/Stratus19/Data/SBE37/{case_name}_sbe37_11394.mat'
mat_file_path2 = f'/Users/Shared/ORS/Stratus/Stratus19/Data/SBE37/{case_name}_sbe37_11379.mat'
