...
# from mooring log
water_depth_from_ship_uncorrected = 4268     # uncorrected water depth, depth recorder reading
water_depth_from_ship_corrected = 4268       # corrected water depth, best water depth
...
# %%
# spike time
deployment_spike_times_start = pd.to_datetime('04/10/2019 14:00') # 
deployment_spike_times_end = pd.to_datetime('04/10/2019 14:18')
recovery_spike_times_start = pd.to_datetime(np.nan)
recovery_spike_times_end = pd.to_datetime(np.nan) 
# no spike - no ice or refigeration available on vessel during recovery
...
# file input
instrument = 'SBE37'
mat_file_path1 = f'/Users/Shared/ORS/Stratus/{case_name}/data/{instrument}/{case_name}_sbe37_10600.mat'
mat_file_path2 = f'/Users/Shared/ORS/Stratus/{case_name}/data/{instrument}/{case_name}_sbe37_10601.mat'
