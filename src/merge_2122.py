...
project_number = 21 # the project number of the last merged dataset
version = 'v1'  # version of the dataset

case_name0 = f'{project_name}{project_number}'
instrument0_1 = '11394'  # instrument serial number for the first dataset

case_name1 = f'{project_name}{project_number+1}'
instrument1_1 = '10600' #chosen
instrument1_2 = '10601' 
