...
data_path = f'/Users/Shared/ORS/DEEP_TS/NTAS/{project_name.lower()}{project_number.lower()}/{version}/'

# Construct the file pattern to search for
file_pattern = os.path.join(data_path, f'{project_name.lower()}{project_number}_*truncated.nc')
