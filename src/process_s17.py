...
# %%
# file input
mat_file_path1 = f'/Users/yugao/UOP/ORS-processing/data/external/{case_name}/{case_name}_sbe37_11394.mat'
mat_file_path2 = f'/Users/yugao/UOP/ORS-processing/data/external/{case_name}/{case_name}_sbe37_12257.mat'
...
valid_time_window = ds.sel(time=slice(anchor_over_time + pd.Timedelta(hours=truncate_hours), 
                                      release_fired_time))
valid_time_window2 = ds2.sel(time=slice(anchor_over_time2 + pd.Timedelta(hours=truncate_hours), 
                                        release_fired_time2))
...
plt.grid(True)
plt.legend(['sbe37_11394', 'sbe37_12257'])
plt.show()
plt.savefig(f'{case_name}_temp_sbe37.png')

# %%
# update the attributes
time_coverage_start_str = str(anchor_over_time + pd.Timedelta(hours=truncate_hours))
